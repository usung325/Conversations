...
import fragment from "./page5/fragment.glsl";
import vertex from "./page5/vertex.glsl";
import * as THREE from "three";
import { useControls, button, Leva } from "leva";

export default function Bg5({ instanceId = "background5" }) {
  return (
...
export function Wrapped({ instanceId }) {
  ...
  const [
    ...
    () => ({
      ...
      color3: "#41aaff", // very light blue
      color4: "#e9edf2", // medium blue
      color5: "#f5177b", // red
      color6: "#fff7b1", // purple
