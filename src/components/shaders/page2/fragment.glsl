precision mediump float;
    ...
    void main() {
        ...
        vec3 color4 = vec3(0.01, 0.03, 0.11);  // EDE3F7
        vec3 color6 = vec3(0.28, 0.02, 0.07);  // B9CC7C
        vec3 color1 = vec3(0.78, 0.23, 0.07);  // C77869
        vec3 color2 = vec3(0.81, 0.52, 0.09);  // C47AAB
        vec3 color5 = vec3(0.9, 0.9, 1.0);  // A0D1EA
        ...
        finalComp = mix(finalComp, layer3, S(-.2, .4, sin(tuv.y*3.+iTime * 0.1)));
